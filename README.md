...
A fully functional simple to-do list application built with **React** that supports complete **CRUD** operations and is deployed as both a web and native mobile application.
